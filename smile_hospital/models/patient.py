...
class DentalPatients(models.Model):
    ...
    procedure_ids = fields.One2many('dental.procedure', 'patient_id', string="Procedures")
    ...
    def action_patient_history(self):
        # self.ensure_one()
        # return {
        #     'type': 'ir.actions.act_window',
        ...
        #     'view_mode': 'form',
        #     'res_id': self.id,
        #     'views': [(self.env.ref('smile_hospital.view_patient_history_form').id, 'form')],
        #     'target': 'current',
        # }
        self.ensure_one()
        return self.env.ref('smile_hospital.report_pdf_patient_history').report_action(self)

    def action_print_patient_history(self):
        """Prints the patient's history as PDF."""
        self.ensure_one()
        return self.env.ref('smile_hospital.report_patient_history').report_action(self)
